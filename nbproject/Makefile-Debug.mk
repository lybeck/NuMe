...
${OBJECTDIR}/src/test/gsltest.o: src/test/gsltest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test/gsltest.o src/test/gsltest.cpp

${OBJECTDIR}/src/test/lam.o: src/test/lam.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test/lam.o src/test/lam.cpp

${OBJECTDIR}/src/test/vectest.o: src/test/vectest.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/test/vectest.o src/test/vectest.cpp
