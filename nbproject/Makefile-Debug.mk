...
${OBJECTDIR}/src/w6/w6e3.o: src/w6/w6e3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/w6
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w6/w6e3.o src/w6/w6e3.cpp

${OBJECTDIR}/src/w6/w6e4.o: src/w6/w6e4.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/w6
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w6/w6e4.o src/w6/w6e4.cpp
...
${OBJECTDIR}/src/w7/w7e1.o: src/w7/w7e1.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w7/w7e1.o src/w7/w7e1.cpp

${OBJECTDIR}/src/w7/w7e5.o: src/w7/w7e5.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/w7
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w7/w7e5.o src/w7/w7e5.cpp

${OBJECTDIR}/src/w8/w8e1.o: src/w8/w8e1.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/w8
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w8/w8e1.o src/w8/w8e1.cpp

${OBJECTDIR}/src/w8/w8e5.o: src/w8/w8e5.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/w8
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w8/w8e5.o src/w8/w8e5.cpp

${OBJECTDIR}/src/w9/w9e1.o: src/w9/w9e1.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/w9
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w9/w9e1.o src/w9/w9e1.cpp

${OBJECTDIR}/src/w9/w9e4.o: src/w9/w9e4.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/w9
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/w9/w9e4.o src/w9/w9e4.cpp
